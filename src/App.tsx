    ...
    >
      ...
      <AnimatePresence>
        {showMenu && (
          ...
          >
            <h3 className="text-xl font-black italic mb-6 border-b-2 border-white/20 pb-2 uppercase tracking-tighter">EL DORREGO</h3>
            ...
            <div className="mt-8 pt-4 border-t-2 border-white/20">
              <p className="text-[10px] font-bold italic opacity-70 uppercase">Edición Especial: Prensa Infantil</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <aside className="md:col-span-4 border-r-0 md:border-r-[6px] border-black pr-0 md:pr-10 space-y-14">
            ...
            <section id="que-es-alero" className="relative text-black">
              <div className="absolute -top-4 -left-4 w-12 h-12 border-t-4 border-left-4 border-black"></div>
          ...
          <main className="md:col-span-8 space-y-16">
            ...
            <div className="border-t-[10px] border-black pt-12">
        ...
        {/* Footer Area */}
        <footer className="mt-20 border-t-[12px] border-black pt-8 flex flex-col md:flex-row justify-between items-center gap-8 text-sm md:text-xl font-black uppercase text-black">
          <div className="flex items-center gap-4 bg-black text-white px-4 py-2">
            <MessageCircle className="w-6 h-6" />
            VOS TAMBIÉN PODÉS SER PERIODISTA
          </div>
          <div className="text-center font-black tracking-tighter text-inherit">SANTA FE DE LA VERA CRUZ</div>
          <div className="flex gap-6 text-2xl">
            <span className="hover:text-blue-600 cursor-pointer">#DORREGO</span>
            <span className="hover:text-red-600 cursor-pointer">#ELALERO</span>
          </div>
        </footer>
